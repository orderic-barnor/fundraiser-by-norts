...
<div class="site-section">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <img src="<?php echo get_template_directory_uri(); ?>/images/img_2.jpg" alt="Image" class="img-fluid">
      </div>
      <div class="col-md-5 ml-auto">
        <h3 class="text-cursive mb-4">Notre Mission</h3>
          <p>Nous croyons que la technologie doit être un moteur de croissance et non un frein pour les entreprises. Notre mission est d’offrir des solutions web modernes, simples et performantes qui s’adaptent aux besoins réels de nos clients.</p>
          <p>Nous mettons l’accent sur la qualité, l’innovation et l’efficacité dans chaque projet que nous réalisons. Chaque ligne de code et chaque design sont pensés pour créer de la valeur et accompagner nos partenaires vers leurs objectifs.</p>
          <p>Notre vision est de bâtir des outils digitaux qui soutiennent la transformation durable des entreprises. Nous voulons être un partenaire fiable qui ouvre de nouvelles perspectives grâce au numérique.</p>
        
          <p><a href="#" class="btn btn-primary rounded-0 px-4">Nous Contacter</a></p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
          ...
          <div class="px-3 pt-3 border-top-0 border border shadow-sm">
            ...
            <div class="py-4">
              <div class="d-flex align-items-center">
                <img src="<?php echo get_template_directory_uri(); ?>/images/person_1.jpg" alt="Image" class="rounded-circle mr-3" width="50">
      ...
      <div class="col-md-4">
        ...
        <div class="cause shadow-sm">
          ...
          <a href="#" class="cause-link d-block">
            <img src="<?php echo get_template_directory_uri(); ?>/images/img_3.jpg" alt="Image" class="img-fluid">
            <div class="custom-progress-wrap">
              <span class="caption">80% complete</span>
              <div class="custom-progress-inner">
