...
<div class="owl-carousel-wrapper">
    <div class="box-92819">
        <h1 class="text-white mb-3">Nos causes</h1>
        <p class="lead text-white">Les causes pour lesquelles nous nous battons pour apporter notre pierre à l'édifice</p>
    </div>
        ...
        <div class="row mb-5 align-items-st">
            <div class="col-md-5">
                <div class="heading-20219">
                    <h2 class="title text-cursive mb-4">Derniere cause en date</h2>
                    ...
                    <p><a href="#" class="btn btn-primary rounded-0 px-4">Faites un don</a></p>
                </div>
            </div>
            <div class="col-md-7">
