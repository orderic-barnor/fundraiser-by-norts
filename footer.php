  <div class="site-section">
      <div class="container">
          ...
          <div class="d-md-flex cta-20101 align-self-center bg-light p-4">
              <div class="">
                  <h2 class="text-cursive">Vous pouvez nous accompagner dans nos actions.</h2>
              </div>
              <div class="ml-auto"><a href="#" class="btn btn-primary">Faites un don</a></div>
          </div>
